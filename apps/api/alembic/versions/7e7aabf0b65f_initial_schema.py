...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["document_id"],
            ["documents.id"],
            name=op.f("fk_clauses_document_id_documents"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(
            ["created_by"], ["users.id"], name=op.f("fk_comparisons_created_by_users")
        ),
        sa.ForeignKeyConstraint(
            ["doc_a_id"], ["documents.id"], name=op.f("fk_comparisons_doc_a_id_documents")
        ),
        sa.ForeignKeyConstraint(
            ["doc_b_id"], ["documents.id"], name=op.f("fk_comparisons_doc_b_id_documents")
        ),
        sa.ForeignKeyConstraint(
            ["team_id"], ["teams.id"], name=op.f("fk_comparisons_team_id_teams")
        ),
